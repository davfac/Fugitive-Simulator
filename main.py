...
def menu(inputUtente):
    ...
    if(inputUtente == "classificazione"):
        ...
        regionePartenza = input("Inserisci la regione da dove vuoi partire: ")
        regioneArrivo = input("Inserisci la regione in cui vuoi arrivare: ")
        ...
        regione = input("Inserisci le regione di cui vuoi verificare il rischio: ")
